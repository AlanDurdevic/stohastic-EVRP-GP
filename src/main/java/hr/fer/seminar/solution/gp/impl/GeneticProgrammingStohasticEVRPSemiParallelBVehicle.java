...
public class GeneticProgrammingStohasticEVRPSemiParallelBVehicle extends GeneticProgrammingStohasticEVRP{

	public GeneticProgrammingStohasticEVRPSemiParallelBVehicle(StohasticEVRPProblem problem) {
		super(problem);
	}
	...
	public List<Vehicle> getUsedVehicles(Genotype<ProgramGene<Double>> programGenotype){
		...
		VehicleSupplier vehicleSupplier = new SemiParallelBVehicleSupplier(vehicles);
