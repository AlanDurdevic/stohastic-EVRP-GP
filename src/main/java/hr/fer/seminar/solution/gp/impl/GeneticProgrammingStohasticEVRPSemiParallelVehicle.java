...
public class GeneticProgrammingStohasticEVRPSemiParallelVehicle extends GeneticProgrammingStohasticEVRP{

	public GeneticProgrammingStohasticEVRPSemiParallelVehicle(StohasticEVRPProblem problem) {
		super(problem);
	}
