...
public class GeneticProgrammingStohasticEVRPSerialVehicle extends GeneticProgrammingStohasticEVRP{

	public GeneticProgrammingStohasticEVRPSerialVehicle(StohasticEVRPProblem problem) {
		super(problem);
	}
