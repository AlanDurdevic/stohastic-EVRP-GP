...
public class StohasticEVRP {
	...
	public static void main(String[] args) {
		...
		try (Scanner sc = new Scanner(System.in)) {
			...
			GeneticProgrammingStohasticEVRP gp = null;
			switch(input) {
			case 1 -> gp = new GeneticProgrammingStohasticEVRPSerialVehicle(problem);
			case 2 -> gp = new GeneticProgrammingStohasticEVRPSemiParallelVehicle(problem);
			case 3 -> gp = new GeneticProgrammingStohasticEVRPParallelVehicle(problem);
			default ->{
